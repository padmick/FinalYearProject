...
# Register RPs
$resourceProviders = @("microsoft.eventgrid","microsoft.insights","microsoft.iotcentral","microsoft.keyvault","microsoft.network","microsoft.operationalinsights","microsoft.servicebus","microsoft.sql","microsoft.storage","microsoft.web","microsoft.compute");
